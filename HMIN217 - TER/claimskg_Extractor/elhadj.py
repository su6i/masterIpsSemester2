...
query_url = "https://www.newtral.es/wp-json/wp/v2/posts?per_page=100&offset=0&categories=1&exclude=80729%2C79970%2C78262%2C78455%2C77275%2C77315%2C77161%2C76907%2C76298%2C75434%2C74706%2C74103%2C74062&_locale=user"
headers = {
...
for p in pages:
    ...
    response = get(
        'https://www.newtral.es/zona-verificacion/fact-check/?página='+p, headers, timeout=5)
